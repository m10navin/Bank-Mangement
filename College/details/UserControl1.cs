...
namespace College.details
{
    public partial class UserControl1 : UserControl
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "SELECT * FROM [Savings] ORDER BY [Account_No]";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Student;Integrated Security=True"))
            {
                try
                {
                    ...
                    string query = "DELETE FROM [Savings] WHERE Account_No = @Account_No";
                    ...
                    string query1 = "SELECT * FROM [Savings] ORDER BY [Account_No]";
